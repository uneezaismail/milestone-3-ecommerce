        ...
        <div className="w-full md:w-2/3 flex flex-col gap-2 sm:gap-4">
          ...
          <div className="mt-2 sm:mt-6">
            ...
            <ul className="list-none mt-4 space-y-2">
              ...
              <li>
                <strong>Fuel Economy:</strong> {product.fuelEconomy}
              </li>
              <li>
                <strong>Interior:</strong> {product.interior}
              </li>
              <li>
                <strong>Safety Features:</strong> {product.safetyFeatures}
              </li>
              <li>
                <strong>Performance:</strong> {product.performance}
              </li>
              <li>
